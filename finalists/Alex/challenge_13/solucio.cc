...
//A partir de aqui empieza el codigo del problema
...
//El shuffle se puede ver como una permutacion de 0,...,N-1
//Basta pues descomponer la permutacion en ciclos disjuntos y calcular el mcm de las longitudes de cada ciclo
//Es decir, basta calcular el orden de la permutacion, viendolo como un problema de teoria de grupos
int main() {
    int casos;
    cin >> casos;
